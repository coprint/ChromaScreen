...
class HomeTab(Gtk.Box):
    ...
    def filament_value(self):
        ...
        if self.bodyBoxTotal == None:
            ...
            oneButtonLabel = Gtk.Label("Loaded", name="loaded-label")
            ...
            self.oneButton = Gtk.Button('1',name ="filament-tab-greeen-button")
            ...
            #self.loadButton.connect("clicked", self.log_files, 'klippy.log')
            ...
            unloadLabel = Gtk.Label(_("Unload"), name="load-unload-label")            
            ...
            #self.unloadButton.connect("clicked", self.log_files, 'klippy.log')
            ...
            extruderInputBox.pack_start(downButton, False, False, 0)
            extruderInputBox.pack_start(extruderLabelBox, False, False, 0)
            extruderInputBox.pack_start(upButton, False, False, 0)

            
            leftFilamentBox = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=10)
            leftFilamentBox.pack_start(greenButtonBox, False, False, 0)
            leftFilamentBox.pack_start(loadUnloadButtonBox, False, False, 0)
